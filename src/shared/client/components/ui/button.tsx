  ...
  "group/button inline-flex shrink-0 cursor-pointer select-none items-center justify-center whitespace-nowrap rounded-lg border border-transparent bg-clip-padding font-medium text-sm outline-none transition-all focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      ...
      size: {
        ...
        xs: "h-11 pointer-fine:h-6 min-w-11 pointer-fine:min-w-0 gap-1 in-data-[slot=button-group]:rounded-lg rounded-md px-2 text-xs has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&_svg:not([class*='size-'])]:size-3",
        sm: "h-11 pointer-fine:h-7 gap-1 in-data-[slot=button-group]:rounded-lg rounded-md pointer-fine:px-2.5 px-3 text-[0.8rem] has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&_svg:not([class*='size-'])]:size-3.5",
        ...
        "icon-xs":
          "pointer-fine:size-6 size-11 in-data-[slot=button-group]:rounded-lg rounded-md [&_svg:not([class*='size-'])]:size-3",
        "icon-sm":
          "pointer-fine:size-7 size-11 in-data-[slot=button-group]:rounded-lg rounded-md",
