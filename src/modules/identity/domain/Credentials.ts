...
export class Credential {
  ...
  static restore(config: {
    ...
    credential.idUser = config.idUser;
    credential.accessToken = config.accessToken;
    credential.refreshToken = config.refreshToken;
    credential.expiresInSeconds = config.expiresInSeconds;
    credential.expirationDate = config.expirationDate;
    credential.createdAt = config.createdAt;
    credential.updatedAt = config.updatedAt;
    return credential;
  }
