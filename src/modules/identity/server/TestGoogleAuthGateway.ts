import type {
  ...
  GoogleUserInfo,
  IGoogleAuthGateway,
} from "~/modules/identity/application/ports/IGoogleAuthGateway";
import { buildScopes } from "~/modules/identity/server/GoogleAuthScopes";
import { DeveloperException } from "~/shared/errors/ApplicationErrors";
import type { GoogleConfig } from "~/shared/server/Config";
