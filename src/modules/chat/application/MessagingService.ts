...
import type { ToolExecutor } from "~/modules/chat/application/ToolExecutor";
import {
...
import type { AssistantMessageOptions } from "~/modules/chat/domain/Chat";
...
import {
  MessageLoader,
  MessageTemplate,
} from "~/modules/chat/server/MessageLoader";
import type {
  AuthService,
...
export class MessagingService {
  ...
  private async sendAssistantContent(
    ...
    sourceMessage: Message,
    recipient: SendMessageRecipient,
    content?: import("~/modules/chat/application/ports/IAiChatGateway").AssistantChannelContent,
  ): Promise<void> {
  ...
  private async createChat(
    chat: Chat,
    sql: DatabaseExecutor["sql"] = this.database.sql,
  ): Promise<void> {
